    ...
    <div class="kt-subheader kt-grid__item">
        <div class="kt-subheader__main">
            ...
            <div class="kt-subheader__breadcrumbs">
                ...
                <span class="kt-subheader__breadcrumbs-separator"></span>
                <a href="{{ route('batch.index') }}" class="kt-subheader__breadcrumbs-link"> Manage Batches </a>
            </div>
        </div>
    </div>
                ...
                <div class="kt-portlet">
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Manage Batches</h3>
                        </div>
                    </div>

                    <div class="kt-portlet__body">
                        <table id="batches" class="table table-bordered">
                            <thead>
                            <tr>
                                <th>Name</th>
                                <th>Email</th>
...
@section('custom-scripts')
    ...
    <script src="{{ asset("js/batches/manage-batch.js") }}"></script>
@endsection
