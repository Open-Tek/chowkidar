...
<div class="kt-aside kt-aside--fixed kt-grid__item kt-grid kt-grid--desktop kt-grid--hor-desktop" id="kt_aside">
    ...
    <div class="kt-aside__brand kt-grid__item " id="kt_aside_brand">
        <div class="kt-aside__brand-logo">
            <a href="/">
                <img alt="Logo" src="<?php echo e(asset("assets/media/logos/sl-logo-small.png")); ?>" />
            </a>
        </div>
    ...
    <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
        <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
            <ul class="kt-menu__nav">
                ...
                <!-- DASHBOARD -->
                <li class="kt-menu__item  kt-menu__item--here <?php echo e(Request::is('dashboard') ? 'kt-menu__item--active' : ''); ?>"
                ...
                <!-- SOCIETY PILLS -->
                <li class="kt-menu__item ht-menu__item--submenu <?php echo e(Request::is('society*') ? 'kt-menu__item--active kt-menu__item--open' : ''); ?>" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                    ...
                    <div class="kt-menu__submenu">
                        ...
                        <ul class="kt-menu__subnav">
                            ...
                            <!-- ADD BATCH PILL -->
                            <li class="kt-menu__item  <?php echo e(Request::is('society/create') ? 'kt-menu__item--active' : ''); ?>" aria-haspopup="true">
                            ...
                            <!-- MANAGE STUDENT PILL -->
                            <li class="kt-menu__item  <?php echo e(Request::is('society') ? 'kt-menu__item--active' : ''); ?>" aria-haspopup="true">
...
<?php /**PATH /Users/karunakukreja/Desktop/Smart Society/chowkidar-server/server/crud-service/resources/views/includes/sidebar-copy.blade.php ENDPATH**/ ?>